...
namespace ixxat_gw_{{channel_name}}
{
    ...
    public:
        DataHandler(std::string &launch_port, std::string &launch_ip, boost::asio::io_service &io_service);
        ~DataHandler();
        
        void SetRosNodeAndAdvertise(ros::NodeHandle *node);
    ...
    private:
        ...
        ros::Publisher publisher_{{pdu}}_;
        {% endfor %}
